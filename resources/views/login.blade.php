...
<head>
    ...
    <style>
        ...
        .tab-container {
            ...
            border-radius: 9999px;
            width: 100%;
            /* Membuat tab mengambil seluruh lebar */
        }
        ...
        .circle img {
            width: 110%;
            /* Gambar lebih besar dari lingkaran */
            height: 110%;
            /* Gambar lebih besar dari lingkaran */
            object-fit: contain;
        }
            ...
            <form action="{{ route('login.post') }}" method="POST">
                ...
                <div class="flex justify-center mb-4"> <!-- Tambahkan margin bawah -->
                    <div class="tab-container">
                        ...
                        <button class="tab-button inactive" id="register-tab" onclick="switchTab('register')"><a
                ...
                <div class="flex items-center justify-between mb-12">
                    <div class="flex items-center">
                        <input id="remember-me" type="checkbox"
                            class="h-4 w-4 text-[#8880df] focus:ring-[#8880df] border-gray-300 rounded">
                ...
                <div>
                    <button type="submit"
                        class="w-full py-3 bg-[#8880df] text-white rounded-3xl text-sm lg:text-base font-medium hover:bg-[#736fdc] transition">
                        Login
                    </button> <!-- ke arah home-->
                </div>
            </form>
